...
Usage Rules
One decision per entry. Immutable history (append‑only).
Link each decision to evidence (issues, PRs, papers, experiments).
Record owner, rationale, and impact. Assign actions & due dates.
Keep entries under one screen; attach detail elsewhere.
ID
Date (UTC)
Title
Owner
...
____
[BLUE]
IEEE numeric as project default; single .bib; CSL‑driven.
#____ / PR‑____
...
____
[BLUE]
DOI/URL mandatory at capture; rest via Zotero sync.
#____
Faster metadata, zero drift
D‑003
____
Discussion Tags
____
[BLUE]
Use [DECISION]/[ACTION]/[INFO]/[RISK] in minutes.
#____
Clear comms
D‑004
____
...
____
[YELLOW]
Evaluate toolchain for real‑time vector graphics.
#____
Perf boost potential
D‑005
____
______
____
...
+++++++++++++++++BREAKBREAKBREAK++++++++++++++++++++++BREAKBREAKBREAK+++++++++++++++++++
